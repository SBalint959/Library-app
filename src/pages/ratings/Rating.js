...
//         try {
//             const response = await fetch("http://localhost:8080/api/reviews/" + bookId + "/" + reviewId,
//                 {
//                     method: "GET",
//                     mode: "cors",
//                     headers: {
...
//         let body = {
//             reviewTitle: testDrive.testDriveConcluded,
//             reviewText: testDrive.testDriveTime,
//             bookid: testDrive.stock.stockID,
